...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"support_qq_group":            common.SupportQQGroup,
		"support_wechat_group_qrcode": common.SupportWeChatGroupQRCode,
		"support_douyin_group_qrcode": common.SupportDouyinGroupQRCode,
